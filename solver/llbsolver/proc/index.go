...
func ForceIndexProcessor(ctx context.Context, result *frontend.Result, s *llbsolver.Solver, j *solver.Job) (*frontend.Result, error) {
	...
	if result.Metadata != nil {
		for _, key := range exptypes.ExporterPlatformKeys {
